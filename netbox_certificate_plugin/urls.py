...
urlpatterns = [
    ...
    path('certificates/<int:pk>/changelog/', views.ObjectChangeLogView.as_view(), name='certificate_changelog'),
    ...
    path('certificate-authorities/<int:pk>/changelog/', views.ObjectChangeLogView.as_view(), name='certificateauthority_changelog'),
    ...
    path('hostnames/<int:pk>/changelog/', views.ObjectChangeLogView.as_view(), name='hostname_changelog'),
]
